...
public class KechengCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KechengCommentbackEntity() {

	}

	public KechengCommentbackEntity(T t) {
		try {
    ...
    public String toString() {
        return "KechengCommentback{" +
            "id=" + id +
            ", kechengId=" + kechengId +
            ", yonghuId=" + yonghuId +
            ", kechengCommentbackText=" + kechengCommentbackText +
            ", replyText=" + replyText +
