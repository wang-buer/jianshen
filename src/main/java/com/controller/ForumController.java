    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                if(dianzhang != null){
                    BeanUtils.copyProperties( dianzhang , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
        ...
        ForumEntity forum = forumService.selectById(id);
            if(forum !=null){
                ...
                //级联表
                    DianzhangEntity dianzhang = dianzhangService.selectById(forum.getDianzhangId());
                if(dianzhang != null){
                    BeanUtils.copyProperties( dianzhang , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setDianzhangId(dianzhang.getId());
                }
                //级联表
                    JiaolianEntity jiaolian = jiaolianService.selectById(forum.getJiaolianId());
