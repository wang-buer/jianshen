...
//                            yonghuEntity.setYonghuJifen(data.get(0));                    //现积分 要改的
//                            yonghuEntity.setHuanyuanTypes(Integer.valueOf(data.get(0)));   //会员类型 要改的
//                            yonghuEntity.setHuiyuandaoqiTime(sdf.parse(data.get(0)));          //年费会员到期时间 要改的
...
//    	ValidatorUtils.validateEntity(user);
        ...
        yonghu.setYonghuJifen(0.0);
        yonghu.setHuiyuandaoqiTime(null);
        yonghu.setYonghuDelete(1);
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
        return R.ok();
