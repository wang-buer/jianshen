<template>
    <div style="backgroundImage: url('/jianshenfanghuiyuan/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">健身房会员管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="店长姓名" class="input" v-if="tableName=='dianzhang'">
                            <el-input v-model="ruleForm.dianzhangName" autocomplete="off" placeholder="店长姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='dianzhang'">
                            <el-input v-model="ruleForm.dianzhangPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.dianzhangName)&& 'dianzhang'==this.tableName){
                                this.$message.error('店长姓名不能为空');
                                return
                            }
                             if('dianzhang' == this.tableName && this.ruleForm.dianzhangPhone&&(!this.$validate.isMobile(this.ruleForm.dianzhangPhone))){
