    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="兑换次数" prop="shangpinDuihuannum">
                       <el-input v-model="ruleForm.shangpinDuihuannum"
                                 placeholder="兑换次数" clearable  :readonly="ro.shangpinDuihuannum"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="兑换次数" prop="shangpinDuihuannum">
                           <el-input v-model="ruleForm.shangpinDuihuannum"
                                     placeholder="兑换次数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinDuihuannum: [
                              { required: true, message: '兑换次数不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
