    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="kechengPrice">
                       <el-input v-model="ruleForm.kechengPrice"
                                 placeholder="购买获得积分" clearable  :readonly="ro.kechengPrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="购买获得积分" prop="kechengPrice">
                           <el-input v-model="ruleForm.kechengPrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="可预约人数" prop="kechengKucunNumber">
                       <el-input v-model="ruleForm.kechengKucunNumber"
                                 placeholder="可预约人数" clearable  :readonly="ro.kechengKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="可预约人数" prop="kechengKucunNumber">
                           <el-input v-model="ruleForm.kechengKucunNumber"
                                     placeholder="可预约人数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
