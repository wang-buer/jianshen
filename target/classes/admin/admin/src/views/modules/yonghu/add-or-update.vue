    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现积分" prop="yonghuJifen">
                       <el-input v-model="ruleForm.yonghuJifen"
                                 placeholder="现积分" clearable  :readonly="ro.yonghuJifen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现积分" prop="yonghuJifen">
                           <el-input v-model="ruleForm.yonghuJifen"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="年费会员到期时间" prop="huiyuandaoqiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.huiyuandaoqiTime"
                                type="datetime"
                                placeholder="年费会员到期时间"
                                :disabled="ro.huiyuandaoqiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huiyuandaoqiTime" label="年费会员到期时间" prop="huiyuandaoqiTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huiyuandaoqiTime: [
                              { required: true, message: '年费会员到期时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
