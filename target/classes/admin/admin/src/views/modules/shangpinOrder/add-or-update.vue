    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="编号" prop="shangpinOrderUuidNumber">
                       <el-input v-model="ruleForm.shangpinOrderUuidNumber"
                                 placeholder="编号" clearable  :readonly="ro.shangpinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="编号" prop="shangpinOrderUuidNumber">
                           <el-input v-model="ruleForm.shangpinOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="兑换数量" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="兑换数量" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="兑换数量" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="兑换数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
